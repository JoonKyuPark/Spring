...
public class Mem_ResumeController {
   ...
   public void mem_Resume_list(Model model,HttpSession session) {
   ...
   public String mem_Resume_create(Mem_ResumeDTO resumeDTO, Mem_Resume_abilityDTO abilityDTO, Mem_Resume_careerListDTO resumeListDTO,HttpSession session) {
      System.out.println("컨트롤러 create post");
      Mem_LoginVO vo = (Mem_LoginVO) session.getAttribute("member_infor");
      resumeDTO.setMember_no(vo.getMember_no());
   ...
   public String resume_default_update(@RequestParam("default") String default_no, HttpSession session) {
      ...
      Mem_LoginVO vo = (Mem_LoginVO) session.getAttribute("member_infor");
      de_resumeDTO.setMember_no(vo.getMember_no());
