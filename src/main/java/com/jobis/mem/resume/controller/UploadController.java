...
public class UploadController {
	...
	public List<Mem_Resume_fileVO> fileVOList(@RequestParam String file_no){
	...
	public void folderCreate(Mem_Resume_fileDTO fileDTO){
		
		fileDTO.setMember_no(1);
