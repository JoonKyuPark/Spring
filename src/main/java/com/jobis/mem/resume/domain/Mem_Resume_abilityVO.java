...
public class Mem_Resume_abilityVO {
	...
	public Mem_Resume_abilityVO(int ac_ability_no, String enter_date, String graduation_date, String school_name,
			String major_1, String major_2, String grade, int resume_no, int ed_division) {
		super();
		this.ac_ability_no = ac_ability_no;
		this.enter_date = enter_date;
		this.graduation_date = graduation_date;
