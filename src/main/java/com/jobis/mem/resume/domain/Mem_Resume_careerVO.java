...
public class Mem_Resume_careerVO {
	@Override
	public String toString() {
		return "Mem_Resume_careerVO [career_no=" + career_no + ", career_year=" + career_year + ", important_ability="
				+ important_ability + ", join_date=" + join_date + ", retire_date=" + retire_date
				+ ", career_work_state=" + career_work_state + ", career_etp_name=" + career_etp_name
				+ ", career_field=" + career_field + ", work_dept=" + work_dept + ", work_rank=" + work_rank
				+ ", work_year=" + work_year + ", work_location=" + work_location + ", work_income=" + work_income
				+ ", responibility_field=" + responibility_field + ", retire_reasion=" + retire_reasion + ", resume_no="
				+ resume_no + "]";
	}

	private int career_no; /* ��»��� ��ȣ */
	private String career_year; /* �Ѱ�� �Ⱓ */
	private String important_ability; /* �ٽɿ��� */
	private String join_date; /* �Ի��� */
	private String retire_date; /* ����� */
	private String career_work_state; /* ��� ����(���/������) */
	private String career_etp_name; /* ���ȸ��� */
	private String career_field; /* ��� ���� */
	private String work_dept; /* �ٹ��μ� */
	private String work_rank; /* ��� ���� */
	private String work_year; /* ��� ���� */
	private String work_location; /* ��� �ٹ����� */
	...
	public Mem_Resume_careerVO(int career_no, String career_year, String important_ability, String join_date,
			String retire_date, String career_work_state, String career_etp_name, String career_field, String work_dept,
			String work_rank, String work_year, String work_location, int work_income, String responibility_field,
			String retire_reasion, int resume_no) {
		super();
