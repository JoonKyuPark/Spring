...
public class Mem_RecruitVO implements Serializable {
	...
	public Mem_RecruitVO(){
		
	}
	
	
	public Mem_RecruitVO(int recruit_no, String recruit_title, String hire_type, String recruit_number,
