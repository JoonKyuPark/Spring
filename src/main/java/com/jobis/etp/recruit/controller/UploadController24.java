...
public class UploadController24 {
	...
	public ResponseEntity<String> insertUploadFile(Etp_mem_uploadDTO dto) throws Exception {
		...
		dto.setMember_no(1);
		// �����ڽ��� ������ �ִ� �θ�
		System.out.println("�θ�"+dto.getFile_parent());
		System.out.println("�θ�"+dto.getFile_extension());
		System.out.println("�θ�"+dto.getFile_name());
		System.out.println("�θ�"+dto.getFile_route());
