...
public class Etp_RecruitDTO {
	...
	public Etp_RecruitDTO(int recruit_no, String recruit_title, String[] hire_type, String recruit_number,
	...
	public String toString() {
		return "Etp_RecruitVO [recruit_no=" + recruit_no + ", recruit_title=" + recruit_title + ", hire_type="
				+ Arrays.toString(hire_type) + ", recruit_number=" + recruit_number + ", income_qualification="
				+ income_qualification + ", max_pay=" + max_pay + ", min_pay=" + min_pay + ", career_check="
				+ Arrays.toString(career_check) + ", career_period=" + career_period + ", ac_ability_no="
				+ ac_ability_no + ", receive_sdate=" + receive_sdate + ", receive_ddate=" + receive_ddate
				+ ", receive_way=" + Arrays.toString(receive_way) + ", ads=" + ads + ", recruit_field=" + recruit_field
				+ ", recruit_position=" + Arrays.toString(recruit_position) + ", recruit_day=" + recruit_day
				+ ", recruit_addr=" + Arrays.toString(recruit_addr) + ", etp_no=" + etp_no + "]";
	}
