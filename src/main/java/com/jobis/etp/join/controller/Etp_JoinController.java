...
import com.jobis.etp.util.MediaUtils;
...
<<<<<<< HEAD
	...
	public String etp_info_updatePOST(Etp_JoinVO vo)throws Exception{
		...
		return "redirect:Etp_Info_UpdateForm";
	}
	...
	@RequestMapping(value="/Etp_RecruitList", method = RequestMethod.POST)
	public void etp_recruitListPOST(Model model)throws Exception{
		model.addAttribute("etp_recruit_list", JoinService.etp_recruit_list());
	}
