...
public class Etp_Mem_ClipDTO {
	...
	public Etp_Mem_ClipDTO(int mem_clip_no, int etp_no, int member_no, String mem_clip_title, String eval_memo,
	...
	public String toString() {
		return "Etp_Mem_ClipVO [mem_clip_no=" + mem_clip_no + ", etp_no=" + etp_no + ", member_no=" + member_no
