...
public class Etp_Mem_ClipDTO {
	...
	public Etp_Mem_ClipDTO(int mem_clip_no, int etp_no, int resume_no, String mem_clip_title, String eval_memo,
	...
	public String toString() {
		return "Etp_Mem_ClipDTO [mem_clip_no=" + mem_clip_no + ", etp_no=" + etp_no + ", resume_no=" + resume_no
				+ ", mem_clip_title=" + mem_clip_title + ", eval_memo=" + eval_memo + ", mem_clip_date=" + mem_clip_date
				+ "]";
	}
