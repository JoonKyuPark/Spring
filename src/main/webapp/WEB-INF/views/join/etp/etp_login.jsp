...
var waring = function(event){
	...
	alert(${sessionScope.etp_infor.etp_id} +"님 로그아웃 되었습니다");
	location.href="/etp_logout"
	...
	<div class="navbar-white col-md-12" style="z-index: 5000;">
		...
		<div
			...
			<ul class="nav navbar-nav">
				...
				<li><a class="page-scroll" href="#about">채용공고등록</a></li>
				<li><a class="page-scroll" href="/exam/etp/etp_Exam_Main">채용시험</a></li>
	...
	<div id="mov" >
		...
		<div id="wrapper">
			...
			<div class="col-md-4">
				...
				<p class="intro-text">
					회원님의 최근 활동을 분석하여 <br>꼭맞는 채용 정보를 추천 합니다.
				</p>
...
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
	...
	<div class="row">
		<div class="col-lg-12" id="back">
			<br><br>
			<h3 id="text1">한눈에 보는</h3>
			<h2 id="text2">잡이즈 서비스 가이드</h2>
			<h4>잡이즈는 클라이언트와 기업이 함께하는 취업 포탈 입니다.</h4>
