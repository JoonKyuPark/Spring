...
<title>Insert title here</title>
 ...
 <script href="../../../../resources/css/main/startbootstrap-agency-gh-pages/js/jqBootstrapValidation.js" ></script> 
 <!-- Theme CSS -->
<script src="http://maxcdn.bootstrapcdn.com/bootstrap/3.2.0/js/bootstrap.min.js"></script>
<link href="../../../../resources/css/main/startbootstrap-agency-gh-pages/css/agency.css" rel="stylesheet">
<link href="../../../../resources/css/main/startbootstrap-agency-gh-pages/css/agency.min.css" rel="stylesheet">
...
<body id="page-top" class="index">
            ...
            <div class="intro-text">
               ...
               <div class="col-md-1">
				<form action="/mem_logout">
               	...
               	<span type="" readonly="readonly">${sessionScope.member_infor.member_id }님	반갑습니다.!
               	</span>
    ...
    <!-- Modal -->
  <button class="btn btn-default" data-target="#layerpop" data-toggle="modal" id="popbutton">모달출력버튼</button><br/>
