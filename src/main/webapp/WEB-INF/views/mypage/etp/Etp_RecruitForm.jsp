      ...
      <div class="form-group row">
         ...
         <div class="col-md-9">
            <select class="form-control" name="ac_ability_no">
               ...
               <option value="8">학력무관</option>
               <option value="1">고등학교졸업</option>
               <option value="2">전문대재학</option>
               <option value="3">초대졸</option>
               <option value="4">4년제대학재학</option>
               <option value="5">4년제대학졸업</option>
               <option value="6">대학원재학</option>
               <option value="7">대학원졸업</option>
            </select>
         </div>
      </div>
      <div class="form-group row">
