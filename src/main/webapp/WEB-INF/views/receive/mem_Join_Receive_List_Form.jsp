...
<body>
   <%@include file="mem_Join_Receive_nav.jsp"%>
                           ...
                           <table class="table table-hover">
                              ...
                              <tbody>
                                 <c:forEach var="i" begin="0"
                                    end="${mem_receive_list.size()-1}" step="1">
                                    <tr height="30">
                                       <td align="right">
                                          <div class="checkbox">
                                             <input type="checkbox"
                                                id="${mem_receive_list[i].recruit_no}"> <label
                                                for="${mem_receive_list[i].recruit_no}"></label>
                                          </div>
                                       </td>
                                       <td align="center"><h4>
                                             <a
                                                href="../recruit_infor/recruit_detail_infor.jsp?id=${mem_receive_list[i].recruit_no}">
                                                ${etp_List[i].etp_name} </a>
                                          </h4></td>
                                       <td align="left"><h4>
                                             ${recruit_List[i].recruit_title}</h4> <br>지원자:명<br>지원서류:이력서</td>
                                       <td align="center">${mem_receive_list[i].receive_date}</td>
                                       <td align="center">${mem_receive_list[i].reading}<br>
                                          <a>지원취소</a></td>
                                    </tr>
