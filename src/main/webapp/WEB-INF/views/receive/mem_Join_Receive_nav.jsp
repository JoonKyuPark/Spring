...
<link rel="stylesheet" type="text/css" href="../../../resources/css/receive/mem/vendor.css">
<link rel="stylesheet" type="text/css" href="../../../resources/css/receive/mem/flat-admin.css">
<!-- Theme -->
<link rel="stylesheet" type="text/css" href="../../../resources/css/receive/mem/theme/blue-sky.css">
<link rel="stylesheet" type="text/css" href="../../../resources/css/receive/mem/theme/blue.css">
				...
				<li class="dropdown active"><a href="#" class="dropdown-toggle"
					...
					<div class="dropdown-menu">
						<ul>
							...
							<li><a>스크랩한 기업정보</a></li>
							<li><a
								href="../Member_Recruit_Log/Member_Recruit_Log_List.jsp">최근
									본 채용정보</a></li>
						</ul>
					</div></li>
				<li class="dropdown "><a href="#" class="dropdown-toggle"
  ...
  <div class="dropdown-container">
    {{list}}
		...
		<div class="app-container">
			...
			<script type="text/javascript" src="../../../resources/js/receive/mem/vendor.js"></script>
			<script type="text/javascript" src="../../../resources/js/receive/mem/app.js"></script>
</body>
</html>