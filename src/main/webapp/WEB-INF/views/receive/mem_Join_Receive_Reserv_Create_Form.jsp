...
<script type="text/javascript">
	function button1_click() {
		...
		swal(
				{
					title : "",
					text : "잡이즈 기본 이력서로 온라인 안심 지원 예약 됩니다. ",
					type : "warning",
					showCancelButton : true,
					confirmButtonText : "안심 지원 하기",
				...
				function() {
					var checked_radio = $('input:radio[name=rdoName]:checked').val();
					  $.ajax({
							type:'post',
							url:'/receive/mem_Join_Receive_Reserv_Create_Form?recruit_no= ${recruit_read.getRecruit_no()}',
							headers: { 
							...
							success:function(result){
								...
								if(result == 'SUCCESS'){
									swal("예약 성공!", "온라인 안심 지원 예약 성공 했습니다.", "success");
								}else if(result == 'fail'){
									swal("예약 실패!", "이미 지원하였습니다.", "warning");
								}
							}	
