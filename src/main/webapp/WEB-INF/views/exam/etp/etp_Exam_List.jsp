				...
				<table id="etp_Exam_Table" class="table table-hover">
					...
					<c:forEach var="Etp_ExamVO" items="${etp_Exam_List}">
						<tr class="etp_Exam_Table_tr">
							...
							<td><a
								href="etp_Exam_MemberList?exam_no=${Etp_ExamVO.exam_no }">[바로가기]</a>
							</td>
						</tr>
		...
		<div class="col-md-12">
			<div class="col-md-4">
				...
				<button class="btn btn-info"
					...
					<font color="black" size="3">시험 등록</font>
				</button>
			</div>
			<div class="col-md-4"></div>
			<div class="col-md-4" align="right">
				<br>
				<button class="btn btn-info" id="exam_update_btn" value="수 정">
					<font color="black" size="3">수 정</font>
				</button>
				<button class="btn btn-info" id="exam_delete_btn">
					<font color="black" size="3">삭 제</font>
				</button>
			</div>
		</div>
