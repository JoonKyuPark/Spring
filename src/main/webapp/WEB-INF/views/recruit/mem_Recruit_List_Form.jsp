...
<body>
	...
	<div id="list_back">
					...
					<div class="col-lg-4">
						<div class="recruit1">
							...
							<div class="row" id="recruit_title">
								...
								<div class="col-lg-3"><center><div id="recruit_cont1">지원자</div><h3>7<a id=recruit_cont1>명</a></h3></center></div>
								<div class="col-lg-3"><center><div id="recruit_cont1">지역</div><h3>${recruit_addr[i]}</h3></center></div>
							</div>
					
							<div class="row">
								<div class="col-lg-8 recruit_money"><h5><a id="recruit_cont1">급여&nbsp;:&nbsp;</a>${recruit_list[i].max_pay}원~${recruit_list[i].min_pay}원</h5></div>
							</div>
							<div class="row">
								<div class="col-lg-8" id="recruit_cont1"><h5><a id="recruit_cont1">&nbsp;&nbsp;&nbsp;회사명&nbsp;:&nbsp;</a>${etp_read_list[i].etp_name}</h5></div>
							</div>
							<div class="row">
								<div class="col-lg-8" id="recruit_cont1"><h5><a id="recruit_cont1">&nbsp;&nbsp;&nbsp;마감일&nbsp;:&nbsp;</a>${recruit_list[i].receive_ddate}</h5></div>
								<a class="col-lg-2" id="heart" onclick="button1_click(${recruit_list[i].recruit_no}, ${mem_clip_count[i] })">&#x2764; <a class="col-lg-2" id="clip_count" >${mem_clip_count[i]}</a> </a> 
							</div>
							<div class="row recruit_bottom">
								<div class="col-lg-8">
									<div id="recruit_field">
										<a id="recruit_cont1">채용분야</a><br>
										컴퓨터&nbsp;&nbsp;  > &nbsp;&nbsp;${recruit_list[i].recruit_field }
									</div>
								</div>
								<div class="col-lg-3"><button id="button4" onclick="button4_click(${recruit_list[i].recruit_no});" class="btn btn-primary btn-lg outline">즉시지원</button></div>
		...
		<center>
		 <br> <br> <br> <br> <br>
			<br> <br> <br>
			<img src="../../../resources/css/recruit/mem/images/estimateBg.png" width="400px" height=auto> 
		<div class="col-lg-12" id="footer_foot">
			<div class="container" id="footer_con_div">
			<a id="footer_con">회사소개</a>
			<a id="footer_con">이용방법</a>
			<a id="footer_con">잡이즈</a>
			<a id="footer_con">이용약관</a>
			<a id="footer_con">FAQ</a>
			<a id="footer_con">개인정보취급방침</a>
			</div>
			<hr id="hr_line">
			<div class="container" id="footer_con_div">
			<a id="footer_con_detail">(주) 잡이즈 </a><br>
			<a id="footer_con_detail">대표이사 : 한무영</a><br>
			<a id="footer_con_detail">CFO : 김민정 박세령 박준규 박찬하 정현우 최형묵  </a><br>
			<a id="footer_con_detail">사업자등록번호 : 111-1111-1111</a><br>
			<a id="footer_con_detail">주소 : 서울특별시 금천구 가산동 371-28</a>
			</div>
		</div>
	</center>
	</div>
