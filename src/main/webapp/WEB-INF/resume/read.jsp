				...
				<div class="card-body col-md-12">
					<form class="resume_form form-horizontal col-lg-12 img-thumbnail">
						<div class="form-group col-lg-12" id="selectArea">
							...
							<br>
							<br>
							<label for="resume_title_input" class="col-lg-2 control-label"> <span class="glyphicon glyphicon-pencil"></span>제목
							</label>
							<div class="col-lg-8">
								<h5>${resume.resume_title}</h5>
							</div>
							<input type="button" value="인쇄" onClick="fnPrint()" class="col-lg-2 btn" />
							<br>
							<br>
							<br>
							<label for="resume_income_input" class="col-lg-2 control-label" style="float: left;"> <i class="fa fa-krw"></i>희망연봉
							</label>
							<div class="col-lg-4">
									...
									<c:forEach items="${career}" var="i" begin="0">
										<div id="career_wrapper">
											<div id="career" class="form-inline career">
												...
												<br>
												<br>
												<label for="resume_work_income_input" class="col-lg-2 control-label"><i class="fa fa-krw"></i>경력연봉</label>
